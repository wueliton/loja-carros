...
class MotorcycleController extends Controller
{
    ...
    {
        $motorcycles = Motorcycle::with('brand:id,name', 'model:id,name', 'images')->select('id', 'title', 'brand', 'model', 'brand_id', 'model_id', 'created_at', 'images')->orderBy('created_at', 'desc')->get();
