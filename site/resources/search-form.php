...
<div class="search">
    ...
    <form id="car-form" method="post" action="buscar.php">
        ...
        <div class="d-flex justify-content-end gap-4">
            <a href="busca-avancada.php" class="button">Busca Avançada</a>
