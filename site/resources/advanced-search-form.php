...
<div class="search" x-data="searchType()">
    <div class="btn-toggle col-lg-4 mb-4">
        <input name="type" value="cars" class="d-none" x-model="type" />
        <button type="button" value="cars" :class="type === 'cars' ? 'active' : ''" x-on:click="changeType('cars')">
            ...
            Carro</button>
        <button type="button" value="motorcycles" :class="type === 'motorcycles' ? 'active' : ''"
            x-on:click="changeType('motorcycles')">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <template x-if="type === 'cars'">
        <div id="cars_content" class="toggle_content active" x-show="type === 'cars'">
            <?php include(__DIR__ . '/advanced-search-cars-form.php'); ?>
        </div>
    </template>
    <template x-if="type === 'motorcycles'">
        <div id="motorcycles_content" class="toggle_content" x-show="type === 'motorcycles'">
